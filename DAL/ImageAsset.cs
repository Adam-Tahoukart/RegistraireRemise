...
namespace DAL
{
    ...
    public class ImageAsset<T>
    {
        ...
        {
            return value.Contains("data:") && value.Contains(";base64,");
        }
        ...
        public void Delete(T data)
        {
            ...
            foreach (var property in type.GetProperties())
            {
                ...
                if (attribute != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(value) && value != assetsFolder + defaultValue)
                        File.Delete(HostingEnvironment.MapPath(value));
                }
            }
        }
